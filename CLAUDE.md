...
BIMA Shelters is a full-stack enterprise management system built with Next.js 15, React 19, TypeScript, and PostgreSQL. The application manages HR, projects, tasks, documents, email communications, and notifications within an organization.
...
BIMA Shelters follows a modular architecture organized by domain/feature:
